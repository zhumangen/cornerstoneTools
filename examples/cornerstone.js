/*! cornerstone - v0.9.0 - 2016-11-05 | (c) 2014 Chris Hafey | https://github.com/chafey/cornerstone */
...
(function ($, cornerstone) {
    ...
    function renderCompositeImage(enabledElement, invalidated) {
        ...
        visibleLayers.forEach(function(layer) {
            ...
            // Create a second stage canvas the same size as the
            // enabledElement canvas.
            var fullSizeCanvas = document.createElement('canvas');
            fullSizeCanvas.width = enabledElement.canvas.width;
            fullSizeCanvas.height = enabledElement.canvas.height;
            var fullSizeContext = fullSizeCanvas.getContext('2d');
            fullSizeContext.setTransform(1, 0, 0, 1, 0, 0);
            fullSizeContext.fillStyle = 'transparent';
            fullSizeContext.fillRect(0, 0, enabledElement.canvas.width, enabledElement.canvas.height);
            ...
            fullSizeContext.drawImage(layer.canvas, 0, 0, layer.image.width, layer.image.height, offset.x, offset.y, layer.image.width, layer.image.height);

            // Draw from second stage canvas onto enabledElement canvas
            context.drawImage(fullSizeCanvas, 0, 0);
